...
module neuron #(
    ...
    generate
        if (NUM_INPUTS == 16) begin
            ...
            assign products[9] = x10 * w10;
            assign products[10] = x11 * w11;
            assign products[11] = x12 * w12;
            assign products[12] = x13 * w13;
            assign products[13] = x14 * w14;
            assign products[14] = x15 * w15;
            assign products[15] = x16 * w16;
        end
