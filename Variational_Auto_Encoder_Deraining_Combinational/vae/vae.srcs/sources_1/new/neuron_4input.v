module neuron_4input #(
    ...
    neuron #(
        ...
        .x5(zero), .x6(zero), .x7(zero), .x8(zero),
        .x9(zero), .x10(zero), .x11(zero), .x12(zero),
        .x13(zero), .x14(zero), .x15(zero), .x16(zero),
        .w1(w1), .w2(w2), .w3(w3), .w4(w4),
        .w5(zero), .w6(zero), .w7(zero), .w8(zero),
        .w9(zero), .w10(zero), .w11(zero), .w12(zero),
        .w13(zero), .w14(zero), .w15(zero), .w16(zero),
        .b(b),
        .y(y)
    );
endmodule