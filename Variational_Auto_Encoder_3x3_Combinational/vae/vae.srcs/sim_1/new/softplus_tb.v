...
module softplus_tb;
    // Parameters matching the softplus module
    ...
    // Instantiate the softplus module
    softplus #(
    ...
    initial begin
        // Print header
        $display("Starting Softplus Function Test");
        ...
        // Test additional points around the transition regions
        test_point(-2.5);
        test_point(-1.5);
        test_point(-0.7);
        test_point(0.7);
        ...
        #100;
        $display("Softplus Function Test Complete");
        $finish;
    end
    ...
    task test_point;
        ...
        begin
            ...
            // Display results
            $display("Test Point: x = %f, softplus(x) = %f", x_real, y_real);
        end
    endtask
