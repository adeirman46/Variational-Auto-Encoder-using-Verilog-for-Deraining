...
module neural_network_pipelined #(
    ...
    output wire signed [ACTIVATION_WIDTH-1:0] out1, out2, out3, out4, out5, out6, out7, out8, out9
);
    ...
    neuron_sigmoid_pipelined n2_1 (
        .clk(clk), .x1(l1_out1), .x2(l1_out2),
        .w1(w2_11), .w2(w2_12), .b(b2_1), .y(out1)
    );
    
    neuron_sigmoid_pipelined n2_2 (
        .clk(clk), .x1(l1_out1), .x2(l1_out2),
        .w1(w2_21), .w2(w2_22), .b(b2_2), .y(out2)
    );
    
    neuron_sigmoid_pipelined n2_3 (
        .clk(clk), .x1(l1_out1), .x2(l1_out2),
        .w1(w2_31), .w2(w2_32), .b(b2_3), .y(out3)
    );
    
    neuron_sigmoid_pipelined n2_4 (
        .clk(clk), .x1(l1_out1), .x2(l1_out2),
        .w1(w2_41), .w2(w2_42), .b(b2_4), .y(out4)
    );
    
    neuron_sigmoid_pipelined n2_5 (
        .clk(clk), .x1(l1_out1), .x2(l1_out2),
        .w1(w2_51), .w2(w2_52), .b(b2_5), .y(out5)
    );
    
    neuron_sigmoid_pipelined n2_6 (
        .clk(clk), .x1(l1_out1), .x2(l1_out2),
        .w1(w2_61), .w2(w2_62), .b(b2_6), .y(out6)
    );
    
    neuron_sigmoid_pipelined n2_7 (
        .clk(clk), .x1(l1_out1), .x2(l1_out2),
        .w1(w2_71), .w2(w2_72), .b(b2_7), .y(out7)
    );
    
    neuron_sigmoid_pipelined n2_8 (
        .clk(clk), .x1(l1_out1), .x2(l1_out2),
        .w1(w2_81), .w2(w2_82), .b(b2_8), .y(out8)
    );
    
    neuron_sigmoid_pipelined n2_9 (
        .clk(clk), .x1(l1_out1), .x2(l1_out2),
